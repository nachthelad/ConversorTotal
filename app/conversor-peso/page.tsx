...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Convierte peso de kilogramos a libras y viceversa al instante. Gratis y preciso.",
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold tracking-tight text-foreground">
          Conversor de Peso y Masa Online
        </h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Convierte peso entre kilogramos y libras de forma instantánea y
          precisa. Perfecto para dietas, ejercicio, viajes y uso médico.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto space-y-8 mt-12">
        <div className="prose prose-gray dark:prose-invert max-w-none">
          <h2 className="text-2xl font-bold mb-2">
            Conversión de Peso: Kilogramos y Libras
          </h2>
          <p>
            Convertir entre <strong>kilogramos (kg)</strong> y{" "}
            <strong>libras (lbs)</strong> es fundamental para dietas, ejercicio,
            viajes y uso médico. Utiliza nuestro conversor para obtener
          ...
          <ul>
            <li>
              <strong>Kilogramos a Libras:</strong>{" "}
              <code>lbs = kg × 2.20462</code>
            </li>
            <li>
              <strong>Libras a Kilogramos:</strong>{" "}
              <code>kg = lbs × 0.453592</code>
            </li>
          </ul>
          ...
          <h3 className="text-xl font-semibold mt-6">
            ¿Cuándo usar un conversor de peso?
          </h3>
          <ul>
            <li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
            ...
            <div className="bg-muted/50 rounded-lg p-4">
              <strong>Peso:</strong> Fuerza gravitacional sobre la masa
              (Newtons)
            </div>
          </div>
        </div>
      ...
      <div className="max-w-3xl mx-auto mt-12">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 flex items-start gap-3 shadow-sm">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-1">
                ¿Cómo convierto kilogramos a libras?
              </h3>
              <p className="text-muted-foreground">
                Ingresa el valor en kilogramos, selecciona "libras" como unidad
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 flex items-start gap-3 shadow-sm">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-1">
                ¿Puedo convertir libras a gramos?
              </h3>
              <p className="text-muted-foreground">
                Sí, selecciona "libras" como unidad de origen y "gramos" como
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 flex items-start gap-3 shadow-sm">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-1">
                ¿El conversor de peso es gratuito?
              </h3>
              <p className="text-muted-foreground">
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 flex items-start gap-3 shadow-sm">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-1">
                ¿Sirve para recetas y dietas?
              </h3>
              <p className="text-muted-foreground">
                Sí, es ideal para calcular ingredientes en recetas y para
                seguimiento de peso en dietas.
              </p>
            </div>
          </div>
        </div>
