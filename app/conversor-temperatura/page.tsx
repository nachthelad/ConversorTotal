...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Convierte temperatura de Celsius a Fahrenheit y viceversa al instante. Gratis y preciso.",
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Convierte temperatura entre Celsius y Fahrenheit de forma instantánea
          y precisa. Ideal para cocina, ciencia, viajes y uso diario.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto space-y-8 mt-12">
        <div className="prose prose-gray dark:prose-invert max-w-none">
          <h2 className="text-2xl font-bold mb-2">
            Conversión de Temperatura: Celsius y Fahrenheit
          </h2>
          <p>
            Convertir entre <strong>Celsius (°C)</strong> y{" "}
            <strong>Fahrenheit (°F)</strong> es esencial para cocina, ciencia,
            viajes y el día a día. Utiliza nuestro conversor para obtener
            resultados instantáneos y precisos, sin complicaciones.
          </p>

          <h3 className="text-xl font-semibold mt-6">Fórmulas de Conversión</h3>
          <ul>
            <li>
              <strong>Celsius a Fahrenheit:</strong>{" "}
              <code>°F = (°C × 9/5) + 32</code>
            </li>
            <li>
              <strong>Fahrenheit a Celsius:</strong>{" "}
          ...
          <h3 className="text-xl font-semibold mt-6">
            ¿Cuándo usar un conversor de temperatura?
          </h3>
          <ul>
            <li>
              <strong>Cocina:</strong> Recetas internacionales con diferentes
              escalas.
            </li>
            <li>
              <strong>Viajes:</strong> Comprender el clima en otros países.
            </li>
            <li>
              <strong>Ciencia:</strong> Experimentos y cálculos precisos.
            </li>
            <li>
              <strong>Medicina:</strong> Interpretar termómetros de distintas
              escalas.
            </li>
            <li>
              <strong>Clima:</strong> Comparar temperaturas globales.
            </li>
          </ul>

          <h3 className="text-xl font-semibold mt-6">
            Ventajas de nuestro conversor
          </h3>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-2 !list-none !pl-0">
            <li className="flex items-center gap-2">
              <span className="text-green-600">✔️</span>
              <span>
                <strong>Instantáneo:</strong> Resultados en tiempo real.
              </span>
            </li>
            <li className="flex items-center gap-2">
              <span className="text-green-600">✔️</span>
            ...
            <li className="flex items-center gap-2">
              <span className="text-green-600">✔️</span>
              <span>
                <strong>Fácil de usar:</strong> Interfaz intuitiva y simple.
              </span>
            </li>
            <li className="flex items-center gap-2">
              <span className="text-green-600">✔️</span>
              <span>
                <strong>Compartir:</strong> Copia o envía resultados por
                WhatsApp.
              </span>
            </li>
          </ul>
      ...
      <div className="max-w-3xl mx-auto mt-12">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 flex items-start gap-3 shadow-sm">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Ingresa el valor en Celsius, selecciona “Fahrenheit” como unidad
                de destino y obtendrás el resultado al instante.
              </p>
            </div>
          </div>
          {/* Pregunta 2 */}
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 flex items-start gap-3 shadow-sm">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-1">
                ¿Puedo convertir Kelvin a Celsius?
              </h3>
              <p className="text-muted-foreground">
                Sí, selecciona “Kelvin” como unidad de origen y “Celsius” como
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 flex items-start gap-3 shadow-sm">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-1">
                ¿El conversor de temperatura es gratuito?
              </h3>
              <p className="text-muted-foreground">
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 flex items-start gap-3 shadow-sm">
            ...
            <div>
              <h3 className="font-semibold text-lg mb-1">
                ¿Sirve para recetas y ciencia?
              </h3>
              <p className="text-muted-foreground">
                Sí, es ideal para cocina, ciencia, clima y uso diario.
              </p>
            </div>
          </div>
        </div>
          ...
          mainEntity: [
            {
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Ingresa el valor en Celsius, selecciona Fahrenheit como unidad de destino y obtendrás el resultado al instante. La fórmula es °F = (°C × 9/5) + 32.",
              },
            },
            {
              "@type": "Question",
