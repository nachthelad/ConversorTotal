...
export const metadata: Metadata = {
  ...
  keywords:
    "términos y condiciones, políticas de uso, ConversorTotal, conversor de unidades",
  openGraph: {
    title: "Términos y Condiciones | ConversorTotal",
    description:
      ...
      <div className="space-y-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              Al acceder y utilizar ConversorTotal, usted acepta estar sujeto a
            ...
            <p>
              ConversorTotal es una herramienta gratuita de conversión de
              unidades, monedas y tallas que proporciona información con fines
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              <strong>Uso Permitido:</strong> Puede utilizar ConversorTotal para
              realizar conversiones de unidades, consultar tipos de cambio y
              convertir talles de ropa y calzado.
            </p>
            <p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              <strong>Tipos de Cambio:</strong> Los tipos de cambio se obtienen
              de fuentes externas y se actualizan regularmente. Sin embargo, no
              garantizamos la precisión absoluta de esta información.
            </p>
            <p>
              <strong>Conversiones:</strong> Las conversiones de unidades y
              tallas se basan en estándares internacionales reconocidos, pero
              pueden variar según el fabricante o región.
            </p>
            <p>
              <strong>Responsabilidad:</strong> ConversorTotal no se hace
              responsable por decisiones tomadas basándose en la información
              proporcionada. Para transacciones importantes, consulte fuentes
              oficiales.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle>4. Publicidad y Google AdSense</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <p>
              ConversorTotal utiliza Google AdSense para mostrar anuncios
              relevantes. Al usar nuestro servicio, aceptas que:
            </p>
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li>
              ...
              <li>
                Los ingresos por publicidad nos ayudan a mantener el servicio
                gratuito
              </li>
            </ul>
            <p className="text-sm text-muted-foreground">
              Para más información sobre las prácticas de Google AdSense,
              consulta la
              <a
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              Todo el contenido, diseño, código y funcionalidades de
              ConversorTotal están protegidos por derechos de autor y otras
              leyes de propiedad intelectual.
            </p>
            <p>
              El uso del servicio no le otorga ningún derecho de propiedad sobre
              el contenido o las funcionalidades.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <p>
              ConversorTotal se proporciona "tal como está" sin garantías de
              ningún tipo. No garantizamos que el servicio sea ininterrumpido,
              libre de errores o completamente seguro.
            </p>
            <p>
              En ningún caso seremos responsables por daños directos,
              indirectos, incidentales o consecuentes que resulten del uso o la
